...
function calc() {
   ...
   function initLocalSettings(selector, activeClass) {
      ...
      elements.forEach(items => {
         ...
         if (items.getAttribute('id') === localStorage.getItem('sex')) {
            items.classList.add(activeClass);
         }
         if (items.getAttribute('data-ratio') === localStorage.getItem('ratio')) {
            items.classList.add(activeClass);
         }
      });
   }
...
window.addEventListener('DOMContentLoaded', () => {
   const modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.openModal)('.modal', modalTimerId), 40000);

   (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_0__["default"])('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
   (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"])('[data-modal]', '.modal', modalTimerId);
   (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2024-01-31');
